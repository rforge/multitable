...
\begin{abstract}
Data frames are integral to \R.  They provide a standard format for passing data to model-fitting and plotting functions.  Still, many data sets do not easily fit into a single data frame---examples abound in my field of community ecology.  
\end{abstract}
